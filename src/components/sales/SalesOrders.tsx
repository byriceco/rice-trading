...
export function SalesOrders() {
  const { salesOrders, customers, addSalesOrder, updateSalesOrder } = useData();
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search by customer or rice type..."
              value={searchTerm}
      ...
      {viewingOrder && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h2 className="text-lg font-semibold mb-4">Sales Order Details</h2>
            <div className="space-y-3">
              <div><span className="font-medium">Order ID:</span> {viewingOrder.id}</div>
              <div><span className="font-medium">Customer:</span> {viewingOrder.customerName}</div>
              ...
              <div><span className="font-medium">Received Amount:</span> ₹{viewingOrder.receivedAmount.toLocaleString()}</div>
            </div>
